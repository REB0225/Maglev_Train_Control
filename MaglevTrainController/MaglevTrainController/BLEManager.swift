...
public class BLEManager: NSObject, ObservableObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    private let serviceUUID = CBUUID(string: "3939acbb-1139-abcd-3939-39390e012345")
    private let characteristicUUID = CBUUID(string: "0e0390e0-39ea-5678-1010-0e0390e03930")
